...
<div class="landing-page weebly">
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav-landing-page">
          <ul class="nav navbar-nav newstore">
    ...
    <div class="full-page-width content-block image-standout" id="overview">
        <div class="container">
    ...
    <div class="full-page-width content-block features" id="features">
        <div class="container">
            <div class="row">
    ...
    <div class="full-page-width content-block faq" id="faq">
        <div class="container">
