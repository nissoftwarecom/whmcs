...
$_ADMINLANG['addons']['areyousuredelete'] = "Вы действительно хотите удалить дополнение?";
...
$_ADMINLANG['browser']['deleteq'] = "Вы действительно хотите удалить эту закладку?";
$_ADMINLANG['browser']['invalidURL'] = "Неправильный URL";
$_ADMINLANG['browser']['invalidURLExplanation'] = "Введите полный адрес в виде as http://www.example.com/path/to/file.php";
...
$_ADMINLANG['general']['sslurlinfo'] = "URL инсталляции WHMCS для безопасного доступа по SSL, напр.: https://www.example.com/members/ (оставьте пустым, если доступ по SSL не настроен)";
...
$_ADMINLANG['general']['enableProformaInvoicing'] = "Сключить proforma-счета";
